...
#define BOARD_NAME        AIRDRONEH562
...
// Motor pins (from schematic PADS - ESC1 & ESC2 connectors)
...
#define TIMER_PIN_MAPPING \
    ...
    TIMER_PIN_MAP(11, RX_PPM_PIN,           1, -1)
